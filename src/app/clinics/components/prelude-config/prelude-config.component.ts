...
export class PreludeConfigComponent implements OnInit {
  ...
  mandatoryFieldNames = ["External Patient ID", "Pet Name", "Breed", "Pet Parent Last Name", "Pet Parent Email", "Baseline Start Date", "Baseline End Date", "Treatment Start Date", "Treatment End Date", "Study Group", "Address Line 1", "City", "State", "Country", "Zipcode", "Timezone"];
  studyName: any;
  formFiledList: any[];

  ...
  next() {
    ...
    if (this.petInfoForm.valid) {
      if (this.editFlag && !this.submitFlag) {
        if ((this.petInfoForm.value.status == "3" && this.formDataCopy.status != "3") || (this.petInfoForm.value.status == "1" && this.formDataCopy.status != "1" && (data.hasOwnProperty('petStudy')) || (this.petInfoForm.value.status == "4" && this.formDataCopy.status != "4"))) {
